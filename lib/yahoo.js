...
exports.getIncomeStatement = function (args, done) {
  exports.fetchIncomeStatement(args, (err, html) => {
...
exports.fetchIncomeStatement = function (args, done) {
  ...
  var url = 'https://finance.yahoo.com/q/is?s=' + args.symbol;
...
exports.getBalanceSheet = function (args, done) {
  exports.fetchBalanceSheet(args, function (err, html) {
    // fs.writeFile('test/fixtures/TSLA-Yahoo-BS.html', html, () => {
...
exports.fetchBalanceSheet = function (args, done) {
  ...
  let url = `https://finance.yahoo.com/quote/{$args.symbol}/balance-sheet`;
  // if (args.period === 'annual') url += '&annual';
...
exports.getCashFlow = function (args, done) {
  exports.fetchCashFlow(args, (err, html) => {
...
exports.fetchCashFlow = function (args, done) {
  ...
  let url = `https://finance.yahoo.com/q/cf?s=${args.symbol}`;
  if (args.period === 'annual') {
    url += '&annual';
  }
